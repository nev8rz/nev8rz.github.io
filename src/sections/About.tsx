          ...
          >
            <div className="code-block rounded-2xl p-8 space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Hi there! I'm <span className="text-green-400 font-mono">Yijin Zhou</span>, 
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="glass rounded-xl p-4 hover:border-green-500/30 transition-colors"
                >
                  <div className="flex items-center gap-2 text-sm text-muted-foreground mb-1">
                    <fact.icon className="w-4 h-4 text-green-400" />
                    {fact.label}
                  </div>
          ...
          >
            {highlights.map((item, index) => (
              <motion.div
                ...
                animate={isInView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.5, delay: 0.4 + index * 0.1 }}
                className="code-block rounded-2xl p-6 hover:bg-green-500/5 transition-all duration-300 group"
              >
